/ip route
add comment=tg-routes disabled=no distance=1 dst-address=91.105.192.0/23 gateway=192.168.1.12 routing-table=main scope=30 suppress-hw-offload=no target-scope=10
add comment=tg-routes disabled=no distance=1 dst-address=91.108.4.0/22 gateway=192.168.1.12 routing-table=main scope=30 suppress-hw-offload=no target-scope=10
add comment=tg-routes disabled=no distance=1 dst-address=91.108.8.0/21 gateway=192.168.1.12 routing-table=main scope=30 suppress-hw-offload=no target-scope=10
add comment=tg-routes disabled=no distance=1 dst-address=91.108.16.0/21 gateway=192.168.1.12 routing-table=main scope=30 suppress-hw-offload=no target-scope=10
